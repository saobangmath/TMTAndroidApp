...
public class StartGame_A extends AppCompatActivity {
    ...
    public class DrawingView extends View {
        ...
        public DrawingView(StartGame_A c) {
...
//                            warningText.invalidate();
                            ...
                            errorCountText.setText(errorCount + " - " + errorRate + "%");
                        }
                        mPath.reset();
                        isPathStarted=false;
                    }
